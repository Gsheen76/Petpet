...
- 快捷菜单改为“聊天、小屋、商店、互动、更多”一行五个入口；互动页提供抚摸、喂食、玩耍和睡觉
- 新增固定在屏幕右下区域的家场景，以及位于画布左侧、不遮挡房间的双列家具装修侧栏
- 家具支持购买、放置、拖动、缩放、旋转、收纳和变换存档，装修时会暂时隐藏小狗
- 小屋内支持左键指定目的地，小狗会沿 2.5D 地面四向移动；固定脚印会随走过的路段逐步消失
- 优化倾斜椭圆终点、可爱箭头和脚印路径反馈，并限制小狗只在地面区域活动
- 小屋小狗支持正坐待机、暖色对话框，以及低精力或手动睡眠时先走到地毯再入睡
- 新增 8 帧、3 FPS 小屋睡眠动画；宠物显示尺寸保持一致，素材缺失时仍有安全回退
- 家场景与家具状态会写入原有存档，旧存档自动补齐，不影响名字、成长、Pet 币、设置和聊天记忆
