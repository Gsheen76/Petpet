...
- 装扮改为仅作用于待机姿势的独立透明贴图，可同时组合帽子、眼镜和颈饰
- 商店新增帽子、颈饰、圆框眼镜、墨镜与小橘子等商品，并支持购买前试戴
- 装饰微调支持直接拖动、缩放、旋转与恢复默认，选中框改为更清晰的黄色
- 新增“持久活力”强化，最高减缓 50% 的清醒属性自然消耗
- 新增随机挖宝事件、分档 Pet币奖励、20 分钟冷却与 30 帧星星眼展示动画
- 玩耍动作提升至 24 FPS，并移除动作期间不自然的尾巴与装饰叠加
- 修复交互与主动说话重叠时，长对话气泡显示不完整的问题
- 低心情和饥饿统一使用简短交互气泡，桌宠本体保持待机装扮外观
