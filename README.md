...
- 家园宠物支持点击移动、四向行走、待机、地毯睡眠和更自然的自主活动
- 家园右上角加入商店与互动入口，状态卡改为可领取和摆放的墙面家具
- 新增独立好感成长、零属性红点提醒，并优化属性卡、宝藏气泡和对话框定位
- 宝藏与小游戏 Pet币基础奖励提高，家园家具商店改为更紧凑的双列布局
- 免费聊天优先使用中国大陆可直连的阿里云函数，并保留 Cloudflare Worker 备用线路
- 默认模型更新为 GLM-4.7-FlashX，扩充游戏知识库与上下文，同时仅在游戏相关问题中注入知识
- 聊天、设置、教程和家园界面继续统一为柔和暖色圆角风格
