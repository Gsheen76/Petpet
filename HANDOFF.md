...
**版本**：v1.7.3 已发布（2026-09-15）；**v1.7.4 开发中**（十八项：送礼反应/聊天搜索/陪伴周报/改名组件素材化/查看陪伴分离/礼物排版统一/遮挡滞回带二次校准/小游戏按键反馈+过期点击门/自动睡醒接线/存档原子写/档案抽取异步/档案防自污染/AI线程兜底/fallback random/Esc误确认送礼/家具clamp单一事实源/idle定时器泄漏——未发，见最近变更表末两行与待办区审计遗留 11 项）
**日期**：2026-09-18
