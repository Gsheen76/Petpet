...
RAIL_AT = (51, 180, 200, 992)
RAIL_TITLE_AT = (-2, 132, 320, 46)           # 「我的伙伴」（rail 正上方，加粗）
PET_CARD_SLOTS = ((76, 222), (76, 420))      # 每卡头像左上（烟花上移80、奶油上移200、右移10，显示px 换算）
...
IDLE_PREVIEW_RECT = (415, 90, 450, 430)
IDLE_FRAME_HEIGHT = 410
IDLE_FPS = 8

# 图3 名字牌（rename_bg 323x63）+ 改名钮（change_name 94x55）：
# 垫正下方居中，两素材均放大 50%（第十五轮后续）；改名钮放牌内右端。
NAME_PLATE_AT = (466, 535, 360, 70)
# 名字在牌内部整体居中（第二十六轮）：可用区 = 牌宽 - 钮宽 - 边距，居中放。
NAME_ART_AT = (478, 538, 220, 64)   # 居中于牌内可用区（左缘~按钮左缘）
RENAME_BUTTON_AT = (700, 538, 113, 66)   # 原生 94x55 × 1.2 等比（不被压扁）
...
TAB_BAR_AT = (279, 610, 728, 124)
CONTENT_AT = (279, 662, 728, 653)
