...
DESKTOP_PET_DIR = os.path.join(ASSETS_DIR, "pets", "lunch_meat", "desktop")
HOME_PET_DIR = os.path.join(ASSETS_DIR, "pets", "ice_cream", "home")
...
HOME_BUTTONS_DIR = os.path.join(HOME_SCENES_DIR, "buttons")
UI_DIR = os.path.join(ASSETS_DIR, "ui")
SHOP_UI_DIR = os.path.join(UI_DIR, "shop")
GIFTS_UI_DIR = os.path.join(UI_DIR, "gifts")
BUBBLE_MENU_DIR = os.path.join(UI_DIR, "bubble_menu")
